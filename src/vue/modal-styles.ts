...
const STYLE_ID = "vue-privacy-consent-modal";

/** Raw CSS string for consumers with strict CSP */
export { MODAL_CSS as consentModalCSS };

/** Inject preference center modal CSS into document head (idempotent, SSR-safe) */
